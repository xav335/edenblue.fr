...
<html class="no-js" lang="fr">
  <head>
    ...
    <title>Eden Blue - Aménagements extérieurs</title>
  </head>
<body class="not-home">
    ...
    <section class="grid-x grid-padding-x" role="gallery">
      ...
      <div class="large-6 medium-12 small-12 cell" text-center>
        ...
        <p data-animation="top">
            ...
            <strong>Eden Blue</strong> vous offre la possibilité de finaliser votre cadre de vie en imaginant  le <strong>Pool House</strong> de vos rêves. </br>
