...
<html class="no-js" lang="fr">
  <head>
    ...
    <title>Eden Blue - Spas - Serie Sport</title>
  </head>
  ...
  <main class="grid-container">
    ...
    <section class="grid-x grid-padding-x" role="spadetail">
      ...
      <div class="large-7 medium-7 small-12 cell">
        <h3 data-animation="top">Activité physique et détente</h3>
        <p data-animation="top">
             ...
             Le système de nage à  contre-courant qui équipe nos spas de nage délivre une puissance pouvant satisfaire le plus sportif des nageurs, des joggeurs ou des passionnés d’aquagym.</br>
            La partie spa est équipée de puissants jets de massage sous-marin. Les sièges ergonomiques à  grande immersion sont dotés des mêmes ensembles multi-jets que nos spas Privilège. </br>
       ...
       <div class="large-5 medium-6 small-12 cell" data-animation="top">
        <a data-fancybox="spa1" href="assets/img/gammesport/edenblue-aquex14.jpg">
            <img src="assets/img/gammesport/edenblue-aquex14.jpg" alt="Spa Club Edenblue">
        </a>    
      </div>
      <br>
      ...
      <div class="large-6 medium-6 small-12 cell">
         <a data-fancybox="spa" href="assets/img/gammesport/aquex19-vuecote-edenblue.png">
            <img src="assets/img/gammesport/aquex19-vuecote-edenblue.png" alt="Spa Club Edenblue">
        </a>
      </div>
