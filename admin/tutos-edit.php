	...
	if (empty($result)) {
		...
		for ($i=1;$i<4;$i++) {
			...
			if(empty($image[$i]) || !isset($image[$i])){
				...
				$img[$i]  = '/photos/tutos/thumbs'. $image[$i];
				$imgval[$i]  = $image[$i];
			}
		}
	}
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<form name="formulaire" class="form-horizontal" method="POST"  action="tutos-fp.php">
					<input type="hidden" name="reference" value="tutos">
