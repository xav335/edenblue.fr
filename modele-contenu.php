  ...
  <main class="grid-container">
    ...
    <section class="grid-x grid-padding-x" role="gallery">
      <div class="large-12 medium-12 small-12 cell">
        ...
        <p data-animation="top">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia aliquid accusamus ea harum blanditiis quasi voluptatum, <a href="#">cupiditate non fuga</a> ipsam culpa ducimus nesciunt doloremque qui quibusdam minus iure! Rem, repudiandae?
        </p>
        <p data-animation="top">
        ...
        <ul data-animation="top">
          ...
          <li>Lorem ipsum dolor sit amet <a href="#">consectetur adipisicing</a> elit.</li>
          <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
          <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
        </ul>
      </div>
