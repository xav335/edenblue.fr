...
<html class="no-js" lang="fr">
  <head>
    ...
    <title>Eden Blue - Spas - Serie Privilege</title>
  </head>
  ...
  <main class="grid-container">
    ...
    <section class="grid-x grid-padding-x" role="spadetail">
      ...
      <div class="large-7 medium-7 small-12 cell">
        <h3 data-animation="top">Le coeur de gamme</h3>
        <p data-animation="top">
            La série Privilège offre des spas équipes de plus de jets, de lumières et d’options. Grâce à  leur jupe en résine, ces spas possèdent une allure très tendance.<br>
