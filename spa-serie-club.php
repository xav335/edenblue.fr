...
<html class="no-js" lang="fr">
  <head>
    ...
    <title>Eden Blue - Spas - Serie Club</title>
  </head>
  ...
  <main class="grid-container">
    ...
    <section class="grid-x grid-padding-x" role="spadetail">
      ...
      <div class="large-7 medium-7 small-12 cell">
        <h3 data-animation="top">La détente a prix abordable</h3>
        <p data-animation="top">
            ...
            La série Club est propulsée par La l’in.ye de Gecko, le système de spa le plus avancé , le plus robuste, le plus flexible et le plus sécuritaire.
        </p>
      </div>
      ...
      <div class="large-6 medium-6 small-12 cell">
         <a data-fancybox="spa" href="assets/img/gammeclub/cl84c.png">
            <img src="assets/img/gammeclub/cl84c.png" alt="Spa Club Edenblue">
        </a>
      </div>
